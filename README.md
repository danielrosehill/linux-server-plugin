...
## Linux Server Management Plugin
...
Claude Code plugin for linux-server slash commands and agents.

## Installation

```bash
/plugin marketplace add danielrosehill/CC-Plugin-linux-server
/plugin install linux-server@danielrosehill
```
